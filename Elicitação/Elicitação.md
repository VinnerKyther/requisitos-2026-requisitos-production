...
**Roteiro Aplicado:**
1. Como é feito o registro de empréstimos atualmente? 
2. Quais os maiores problemas enfrentados com atrasos ou avarias?
3. O que não poderia faltar em um sistema digital de gestão?
...
**Roteiro Aplicado:**
1. O processo manual atual atrasa o início das suas aulas?
2. Você utilizaria o próprio celular (via QR Code/NFC) para agilizar a retirada do equipamento?
